...
-- 'SELECT *' means you are selecting everything
...
-- where clause can only be used on key columns
-- unles you set sql_safe_updates to false
UPDATE products
SET coffee_origin = 'Sri Lanka'
WHERE id = 7;

-- delete data in a table
-- you can delte multiple rows in a table, you just have to specify the column name
-- in the 'where' clause having the similarities you want to delete
